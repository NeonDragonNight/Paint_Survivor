...
func _ready():
	...
	var te = "res://src/xlam/test_skil_1.tscn"
	var tes : PackedScene = load(te)
	var new_t = tes.instantiate()
	$coin/skil.add_child(new_t)
	
	var te2 = "res://src/xlam/test_ult.tscn"
	var tes2 : PackedScene = load(te2)
	var new_t2 = tes2.instantiate()
	$coin/ult2.add_child(new_t2)
...
func add_ult_energy():
		$coin/ult2.get_child(0).add_ult_energy()

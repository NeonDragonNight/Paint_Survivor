...
func _ready():
	...
	#var player_node = get_node(char_type)
	
	#var player_node = new_char
	
	#new_spawner.player_node = player_node #char_type = char_type #tut menal<------------
...
func pauuse():
	...
	#new_pause.levl_node = "/root/test_level_1"

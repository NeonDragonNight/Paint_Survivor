...
func unlock_check():
	if char_abilitys_unlock["monk"]["skil2"]:
		$skil2_unlock.hide()
	if char_abilitys_unlock["monk"]["skil3"]:
		$skil3_unlock.hide()
	if char_abilitys_unlock["monk"]["ult2"]:
		$ult2_unlock.hide()
...
func _on_skil_2_unlock_pressed():
	if $"../..".all_gold > 10000:
		...
		char_abilitys_unlock["monk"]["skil2"] = true
		$skil2_unlock.hide()
		$"../..".save_data()
	else :
...
func _on_skil_3_unlock_pressed():
	if $"../..".all_gold > 15000:
		...
		char_abilitys_unlock["monk"]["skil3"] = true
		$skil3_unlock.hide()
		$"../..".save_data()
	else :
		$"../../sounds/button_disable".play()
...
func _on_ult_2_unlock_pressed():
	if $"../..".all_gold > 25000:
		...
		char_abilitys_unlock["monk"]["ult2"] = true
		$ult2_unlock.hide()
		$"../..".save_data()
	else :
		$"../../sounds/button_disable".play()

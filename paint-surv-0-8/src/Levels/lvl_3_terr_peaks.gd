...
func _ready():
	...
	var spawner : PackedScene = load("res://src/Levels/spawner_lvl_3_v_1.tscn")
	...
	$AudioStreamPlayer.volume_db = sound_volume - 18
...
func win(coins, kill, minuts, secund):
	var menu = load("res://src/Menu/lvl win/lvl3_win_menu.tscn").instantiate()
	menu.gold = coins
	menu.kils = kill
